...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	function updateRender(icon_num)
	{
			...
			$.getJSON('fullview.php?thread_num='+icon_num,{}
			,function(data)
			{
	...
	function updateRender_preview(icon_num)
	{
			$('#loading').fadeIn('slow');
;
			$.getJSON('displaythread.php?thread_num='+icon_num,{}
			,function(data)
			{
...
ul.measurements li,ul.measurements li a
{
	...
	text-transform:uppercase;
                ...
                <ul class="" id="menu">
                  <li><a href="step1.html">Shirt Types</a></li>
                  <li class="active"><a href="step2.php">Fabrics</a></li>
                  <li class=""><a href="index.php?r=design/default&amp;step=2&amp;step=3&amp;step=2&amp;step=1&amp;step=2&amp;step=1&amp;step=3">Collars</a></li>
                  <li class=""><a href="index.php?r=design/default&amp;step=2&amp;step=3&amp;step=2&amp;step=1&amp;step=2&amp;step=1&amp;step=4">Cuffs</a></li>
                </ul>
...
#buttonWidget ol li a
{
	...
	background-color:black;
              ...
              <div class="title">
                ...
                <?
					$id = str_replace('Icon-Thread-','',$file );
                ...
                <div class="imageBox"><img  style="" src="design/thread/<?=$file?>" class="img1"  title="" onClick="showthread('<?=$id?>');" />
                          <div id="imageTitle2" style="margin-top:15px;"><?=$s?></div>
                          </div>
