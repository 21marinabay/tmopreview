...
<script src="inc/func.js"></script>
	...
	$(document).ready(function(){
		...
		$('#slideshowImage').load('ajaxcallAllfabrics.php');
		}
		...
		$('#slideshowImage').load('ajaxcallAllpattern.php');
		...
		$('#slideshowImage').load('ajaxcallPrint.php');
		
		
		}
		function loadStriped()
		{

		$('#slideshowImage').load('ajaxcallStriped.php');
		
		}

		function loadCheckered()
		{

		$('#slideshowImage').load('ajaxcallCheckered.php');

		}
		function loadPlain()
		{

		$('#slideshowImage').load('ajaxcallPlain.php');
...
{	
?>	alert('<?php echo $row['Pattern'];?>');
<?php } ?>
	}
	function showfabric_plain()
	{
		<?php
$all = "select * from fabricsnew where Pattern='Plain'";
$query = $db->getAll($all); 
$query1 = mysql_query($all);
while($row=mysql_fetch_array($query1))
{	
?>	alert('<?php echo $row['Filename'];?>');
<?php } ?>
			
	}

	function showfabric_stripped()
	{
		<?php
...
<?php } ?>
	...
	function showfabric_allpattern()
	{
		alert('showfabric_allpattern');
			
	}
	
	function showfabric_checkered()
	{
		<?php
