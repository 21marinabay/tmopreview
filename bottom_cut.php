...
$point = 4;
$layer = 9;
$script = 'Displaycollar_inner.php';
$folder = 'Fabric';
...
<script src="inc/func.js"></script>
	...
	function updateRender(bottom_cut)
	{
			$('#loading').fadeIn('slow');
	...
	function showbottom_cut(bottom_cut)
	{
			
			set_value('step8',bottom_cut);
			updateRender(bottom_cut);
	}
	...
	$(document).ready(function(){
        ...
        <tbody>
            ...
            <td><div id = "design_window">
                  ...
                  <div class="toolbox" style="height:612px;">
                  <style>
#buttonWidget
{
	height:38px;
