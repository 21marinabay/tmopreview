...
<script src="inc/func.js"></script>
	...
	function showyoke(yoke)
	{
		
			set_value('step10',yoke);
			updateRender()
			updateRender_preview(yoke)
	}
	
	function updateRender_preview(yoke)
	{
			$('#loading').fadeIn('slow');
...
.fabricTitle
{
	font-size:15pt;
                  ...
                  <div class="toolbox" style="height:532px;">
                  <style>
#buttonWidget
{
	position:relative;
