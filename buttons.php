...
$point = 1;
$layer = 5;
$script = 'DisplayButtons.php';
$folder = 'buttons';

$sql = "select * from buttons order by item_order ASC";
$res = $db->getAll($sql);
...
if ($handle = opendir('design/buttons')) {
...
<script src="inc/func.js"></script>
	...
	function updateRender_preview(button)
	{
			$('#loading').fadeIn('slow');
...
<br /><br /><br /><br />
  ...
  <!-- header -->
	...
	$(document).ready(function(){
        ...
        <tbody>
            ...
            <td><div id = "design_window">
              ...
              <div style="height:720px;" class="toolbox">
		...
		<? foreach($filename as $f): ?>
                <?
					$id = str_replace('.jpg','',$f);
					$id = str_replace('Button.','',$id);

				?>
				
		<div style="text-align:center;width:63px;margin:2px;margin-bottom:20px;height:80px;float:left;cursor:pointer;" onClick="showbutton('<?=$id?>');" >
		<img class="img1" src="design/buttons/<?=$f?>"><div style=""><br /><?=$label[$f]['label']?>
        <br />
                          $<?=$label[$f]['price']?>
        </div>
		</div>
	...
	<div style="clear:both;"></div>
                ...
                <tr>
                      <td><span style="font-weight:bold;">button Information</span> <br />
                    White </td>
                      <td></td>
                    </tr>
              </table></td>
